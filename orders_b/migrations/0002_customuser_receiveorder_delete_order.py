# Generated by Django 5.0.7 on 2024-07-11 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_after",
                    models.ImageField(blank=True, null=True, upload_to="orders/after/"),
                ),
                (
                    "status",
                    models.CharField(
                        choices=[("accepted", "수락"), ("rejected", "거절")], max_length=10
                    ),
                ),
                (
                    "business_user",
